        ...
        .then(
          ([
            ...
            var EmergencyTreatment = new FeatureLayer({
              title: "急诊部门",
              url: "https://edutrial.geoscene.cn/geoscene/rest/services/Hosted/POI/FeatureServer/2",
              /* popupTemplate: template, */
            });
            map.add(EmergencyTreatment);
            var hospitalLayer = new FeatureLayer({
              title: "综合医院",
              url: "https://edutrial.geoscene.cn/geoscene/rest/services/Hosted/POI/FeatureServer/0",
              /* popupTemplate: template, */
            });
            map.add(hospitalLayer);
            var FeverClinic = new FeatureLayer({
              title: "发热部门",
              url: "https://edutrial.geoscene.cn/geoscene/rest/services/Hosted/POI/FeatureServer/4",
            });
            map.add(FeverClinic);
            var nucleicacidTest = new FeatureLayer({
              title: "核酸检测点",
              url: "https://edutrial.geoscene.cn/geoscene/rest/services/Hosted/POI/FeatureServer/3",
            });
